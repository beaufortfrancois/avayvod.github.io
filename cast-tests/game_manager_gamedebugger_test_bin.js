...
function testCreatePlayer() {
  gameManagerTestHelper.asyncAssertAndSignalCreatePlayer("Player", chrome.cast.games.PlayerState.AVAILABLE, 1);
  asyncTestCase.waitForSignals(1, "Waiting for player to be created");
}
function testAllPlayerTransitions() {
  var ready = chrome.cast.games.PlayerState.READY, quit = chrome.cast.games.PlayerState.QUIT, available = chrome.cast.games.PlayerState.AVAILABLE, playing = chrome.cast.games.PlayerState.PLAYING, idle = chrome.cast.games.PlayerState.IDLE;
  gameManagerTestHelper.asyncAssertAndSignalPlayerStateTransitions("Player", [ready, playing, idle, playing, idle, quit, available, ready, playing, idle, available, ready, playing, quit, available, ready, quit, available, ready, available, quit]);
