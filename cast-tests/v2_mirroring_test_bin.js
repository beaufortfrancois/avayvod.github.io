...
;var MEDIA_URL = castv2testing.e2e.Utilities.GetMediaUrl();
function goFullScreen() {
  document.getElementById("video_player").webkitRequestFullScreen();
}
function startV2Mirroring() {
  isSuccessful = !1;
  controller.initialize("0F5096E8", sessionListener_, function(availability) {
    console.log("receiver is " + availability);
    initSuccessful && !isReceiverAvailable && availability == chrome.cast.ReceiverAvailability.AVAILABLE && (isReceiverAvailable = !0, requestSession());
  }, function() {
    initSuccessful = !0;
    console.log("initialization successfully");
  }, function(error) {
