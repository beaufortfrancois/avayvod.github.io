...
asyncTestCase.stepTimeout = 25E3;
var controller = new castv2testing.e2e.Controller;
function setUpPage() {
  asyncTestCase.setTests([new goog.testing.TestCase.Test("testLoadAPIScript", testLoadAPIScript), new goog.testing.TestCase.Test("testValidDialAppName", testValidDialAppName)]);
}
...
function testValidDialAppName() {
  controller.initialize("INVALID-APP-ID", null, function(availability) {
    availability == chrome.cast.ReceiverAvailability.AVAILABLE && asyncTestCase.continueTesting();
  }, null, function(error) {
